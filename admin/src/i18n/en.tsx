const en = {
  ...
  customerSupport: {
    title: 'Customer Support',
    save: {
      success: 'Customer support settings successfully saved.',
    },
    fields: {
      contactMethod: 'Support Method',
      liveChatCode: 'Live Chat Widget Code',
    },
    contactMethod: {
      livechat: 'Live Chat',
      category: 'WhatsApp / Telegram',
      hint:
        'Choose which support option customers see. You can fill in both, but only the selected one is shown.',
    },
    liveChat: {
      hint:
        'Paste the embed code/script provided by your live chat provider (e.g. Tawk.to). It is saved even when not selected, so you can prepare it in advance.',
    },
    category: {
      hint: 'Manage the WhatsApp and Telegram numbers customers will be shown.',
      manage: 'Manage WhatsApp / Telegram numbers',
    },
  },
